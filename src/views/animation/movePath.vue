<template>
  <canvas width="1200" height="600" id="MovePathWrap"></canvas>
</template>
...
export default defineComponent({
  ...
  setup () {
    ...
    const starNames = {} // 指向显示的星星名字对象
    let displayName // 当前显示名字

    const clock = new THREE.Clock() // 第一人称控制需要
    ...
    function init () {
      ...
      /* 画布大小 */
      canvas = document.getElementById('MovePathWrap')
      ...
      /* sun skin pic */
      const sunSkinPic = THREE.ImageUtils.loadTexture('../resource/img/sunCore.jpg', {}, () => {
      ...
      Earth = initPlanet('Earth', 0.010, 0, 'rgb(46,69,119)', 40, 5)
      stars.push(Earth)
